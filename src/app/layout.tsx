...
export const metadata: Metadata = {
  title: "Pure Soap Co | Handmade Natural Soaps",
  description: "Discover luxurious handmade soaps crafted with 100% natural ingredients. Eco-friendly, sustainable, and perfect for all skin types.",
  keywords: "handmade soap, natural soap, artisan soap, organic soap, eco-friendly",
  metadataBase: new URL("https://puresoapco.com"),
  alternates: {
    canonical: "https://puresoapco.com"
  },
  openGraph: {
    title: "Pure Soap Co | Handmade Natural Soaps",
    description: "Discover luxurious handmade soaps crafted with 100% natural ingredients.",
    type: "website",
    siteName: "Pure Soap Co",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/uploaded-1765890583212-48mobmw3.jpg",
      alt: "Pure Soap Co Handmade Soaps"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "Pure Soap Co | Handmade Natural Soaps",
    description: "Luxurious handmade soaps with 100% natural ingredients",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/uploaded-1765890583212-48mobmw3.jpg"]
  }
};
